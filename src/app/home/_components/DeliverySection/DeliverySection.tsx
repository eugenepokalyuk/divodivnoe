...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: 'Дата, время, адрес и открытка. Оплата онлайн.',
  },
  {
    step: '03',
    title: 'Собираем и показываем',
    text: 'Присылаем фото готового букета для согласования.',
  },
  {
    step: '04',
    title: 'Доставляем',
    text: `Стоимость и время доставки считаем индивидуально: зависит от района и удалённости. От 5 000 ₽ дарим транспортировочный набор — коробку и аквабокс.`,
  },
];
