...
export const AboutIntro: FC = () => (
  <div className={classes.intro}>
    ...
    <p className={classes.text}>
      «{CompanyName}» — небольшая мастерская авторской флористики. Мы не собираем
      букеты по шаблону: спрашиваем про повод, про человека, про то, какое
      чувство нужно передать — и складываем это в цветы.
    </p>
  </div>
);
