 ...
 *  — разъедется по всем кнопкам «Написать» разом.
 *
 *  Только адресаты, которым пишут. Группа и канал сюда не добавляются —
 *  для них TelegramGroup ниже.
 *
 ...
 *  Намеренно отдельно от TelegramContact — в группу не пишут заказ,
 *  и подставлять её туда, где ждут личный чат флориста, нельзя. */
